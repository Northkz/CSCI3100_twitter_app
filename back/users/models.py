...
class User(AbstractUser):
    ...
    avatar = models.ImageField(default='default_ap5zsl.jpg', upload_to='avatars')
    cover_image = models.ImageField(default='cover_for_profile_h5ex4q.jpg', upload_to='avatars')
